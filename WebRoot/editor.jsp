...
<div class="container">
   ...
   <form name="example" method="post" action="activityAction">
   <label>标题：</label><input type="text" class="text" name="activityHeadLine"/>
   <textarea class="textarea" id="editor_id"  name="activityDec"></textarea>
   <div class="sort">
   	<span class="left">
   	分类：<select name="activitySortId">
